...
data = pd.read_csv('/home/lassco/Adriel/pesquisa/DES5YR/DES-SN5YR_HD+MetaData.csv', sep=',', header = 0)
#display(data)
...
data_sys_errors = np.loadtxt('/home/lassco/Adriel/pesquisa/DES5YR/covsys_000.txt', skiprows=1) #load txt and skip the first term 

with open('/home/lassco/Adriel/pesquisa/DES5YR/covsys_000.txt') as f: n = int(f.readline().strip())  #read the first term of txt and save as 'n'
